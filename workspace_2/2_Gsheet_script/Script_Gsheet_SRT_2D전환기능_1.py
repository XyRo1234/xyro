...
excelfile ='D:\\Program Files\\workspace_2\\2_Gsheet_script\\VF 스크립트.xlsx'
path = 'D:\\Program Files\\workspace_2\\2_Gsheet_script'
...
def start_1(sheet_name, path, df):
    ...
    with open(f'{path}\\{sheet_name}.srt', 'w', encoding='UTF-8-SIG') as fl:   # 파일 생성
...
'''
xlsx_name = path + '\\Text_All.xlsx'       # 생성되는 2D Text 엑셀파일명
