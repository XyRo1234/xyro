...
path = 'D:\영상콘텐츠\냉장고\언어vari_220225_SE_VN_1차'
...
for excelname in path_file_list:
    CC_path = excelname.split("\\LG")[0]    # 경로\\LG_RF_SXS_Feedback_Sheet.xlsx 와같은 파일명일때 동작함.
    print("파일열기: ",excelname)
