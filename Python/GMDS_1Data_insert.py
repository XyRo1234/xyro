...
# # //*[@id="main_pack"]/section[1]/div/div[2]/div[2]/div[1]/div[3]/div[1]/div/p/span[1]

# """ line 리스트 만들기 """

# path2 = "D:\\Program Files\\Workspace\\others\\GMDS\\"
...
filename = 'GMDS_Topic_Test.xlsx'                       # 엑셀파일명
df = pd.read_excel(f'{path}{filename}', index_col=None) # 엑셀 DataFrame 가져오기
i = 0
while i<100:
    try:
        No = int(df.loc[i,'No'])
        print(No)
        GMDS_filename = df.loc[i,'filename']                    # 불러올 파일명(txt)
        path2 = "D:\\Program Files\\Workspace\\others\\GMDS\\"  # 불러올 파일(txt) 경로
        ...
        """ <넘버Search 및 Open in Editor 클릭> """
        # browser.find_element_by_xpath('/html/body/div[2]/div[2]/div[1]/form/div[2]/div[1]/input').send_keys(No)
        # browser.find_element_by_xpath('/html/body/div[2]/div[2]/div[1]/form/div[10]/div[3]/div/button').click()   # search 클릭
        # browser.find_element_by_xpath('/html/body/div[2]/div[2]/div[3]/table/tbody/tr/td[13]/i').click()          # Preview 클릭
        # browser.find_element_by_xpath('/html/body/div[5]/div[2]/div[1]/div[2]/a').click()                         # Open in Editor 클릭
        # time.sleep(3)
