...
def start():
    for file in list_file.get(0, END):
        ...
        m = p.search(file)         # ex)  <re.Match object; span=(0, 5), match='ar-AE'>
        lang2 = m.group()                  # ex)  ar-AE
        print(lang2)
        if lang2 == 'es-41':
            start_1(file, lang1, 'es-419')
        elif lang2 == 'uz-La':
            start_1(file, lang1, 'uz-Latn-UZ')
        elif lang2 == 'az-La':
            start_1(file, lang1, 'az-Latn-AZ')
        elif lang2 == 'bs-La':
            start_1(file, lang1, 'bs-Latn-BA')
        elif lang2 == 'sr-La':
            start_1(file, lang1, 'sr-Latn-RS')
        else:
            start_1(file, lang1, lang2)


def start_1(file_fullname,lang1, lang2):
